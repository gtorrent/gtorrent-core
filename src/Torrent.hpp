...
namespace gt {
  class Torrent{
   ...
   public:
    ...
    // TODO(general): Remove this, duplicate of getSize()
    ...
    inline boost::int64_t getRemaining() {
      ...
      m_handle.status().total_wanted_done;
    }

    // Returns a friendly string for the total size
    // of files remaining to download in torrent
